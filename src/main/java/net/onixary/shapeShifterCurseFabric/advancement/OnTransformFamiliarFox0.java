...
public class OnTransformFamiliarFox0 extends AbstractCriterion<OnTransformFamiliarFox0.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_familiar_fox_0");
