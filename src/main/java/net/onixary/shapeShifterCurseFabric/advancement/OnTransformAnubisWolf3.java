...
public class OnTransformAnubisWolf3 extends AbstractCriterion<OnTransformAnubisWolf3.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_anubis_wolf_3");
