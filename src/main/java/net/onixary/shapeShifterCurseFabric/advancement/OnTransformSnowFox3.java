...
public class OnTransformSnowFox3 extends AbstractCriterion<OnTransformSnowFox3.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_snow_fox_3");
