...
public class OnTransformFeralCatSP extends AbstractCriterion<OnTransformFeralCatSP.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_feral_cat_sp");
