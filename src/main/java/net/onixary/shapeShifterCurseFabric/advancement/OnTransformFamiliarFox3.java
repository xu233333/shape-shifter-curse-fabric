...
public class OnTransformFamiliarFox3 extends AbstractCriterion<OnTransformFamiliarFox3.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_familiar_fox_3");
