...
public class OnTransformAnubisWolf0 extends AbstractCriterion<OnTransformAnubisWolf0.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_anubis_wolf_0");
