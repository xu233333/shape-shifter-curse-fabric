...
public class OnTransformBat3 extends AbstractCriterion<OnTransformBat3.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_bat_3");
