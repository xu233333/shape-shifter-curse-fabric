...
public class OnTransformOcelot0 extends AbstractCriterion<OnTransformOcelot0.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_ocelot_0");
