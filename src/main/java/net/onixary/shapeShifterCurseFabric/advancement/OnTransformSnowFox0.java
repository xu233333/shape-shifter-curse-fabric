...
public class OnTransformSnowFox0 extends AbstractCriterion<OnTransformSnowFox0.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_snow_fox_0");
