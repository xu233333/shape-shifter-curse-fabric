...
public class OnTransform3 extends AbstractCriterion<OnTransform3.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_3");
