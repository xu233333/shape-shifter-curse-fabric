...
public class OnTransformAxolotl0 extends AbstractCriterion<OnTransformAxolotl0.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_axolotl_0");
