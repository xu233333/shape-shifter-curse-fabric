...
public class OnTransformAllaySP extends AbstractCriterion<OnTransformAllaySP.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_allay_sp");
