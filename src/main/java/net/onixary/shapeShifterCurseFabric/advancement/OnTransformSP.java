...
public class OnTransformSP extends AbstractCriterion<OnTransformSP.Condition> {
    public static final Identifier ID = new Identifier(ShapeShifterCurseFabric.MOD_ID, "on_transform_sp");
